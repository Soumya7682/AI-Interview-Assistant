...
function Home() {
  ...
  return (
    <div className='min-h-screen bg-[#50377e] flex flex-col'>
      <Navbar />
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              className=' text-white text-4xl md:text-6xl font-semibold leading-tight max-w-4xl mx-auto'>
            ...
            <motion.p
              ...
              className='text-black mt-6 max-w-2xl mx-auto text-lg'>
